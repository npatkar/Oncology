...
module App
  module Config
    ...
    @@submissions_email = ['manuscripts@theoncologist.com', 'marty3rd@alphamedpress.com', 'MaryMaiorino@alphamedpress.com', 'tinabelle@alphamedpress.com']

    #@@submissions_email = ['anthony@sageserver.com', 'marty3rd@alphamedpress.com', 'brian@sageserver.com']
